...
class SpellWidget(QtWebKit.QWebView):
    ...
    def expand_placeholders(self):
        ...
        self._replace({
            ...
            '${DAMAGE_CLASS}': self.spell.dmg_class,
            ...
            '${EQUIPPED_ITEM_CLASS}': self.spell.equipped_class,
            '${EQUIPPED_ITEM_SUBCLASS}': hex(self.spell.equipped_submask),
            '${EQUIPPED_ITEM_INVMASK}': hex(self.spell.equipped_invmask),
